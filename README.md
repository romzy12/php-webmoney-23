...
[![Packagist](https://img.shields.io/packagist/v/baibaratsky/php-webmoney.svg)](https://packagist.org/packages/prnewsteam/php-webmoney)
[![Packagist](https://img.shields.io/packagist/dt/baibaratsky/php-webmoney.svg)](https://packagist.org/packages/prnewsteam/php-webmoney)
...
0. Add the php-webmoney dependency:
    ...
    ```
    php composer.phar require prnewsteam/php-webmoney:0.18.*
    ```
